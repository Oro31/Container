...
///////////////////////////************************////////////////////////////////
			...
			public:
				...
				MapIt() {}
				MapIt(const MapIt<typename ft::remove_const<U>::type> &it) : _p(it._p), _end(it._end) {}
				~MapIt() {};
///////////////////////////************************////////////////////////////////
				...
				pointer operator->() const {return &(_p->pair);}
				Node *base() {return _p;}
...
///////////////////////////************************////////////////////////////////
		...
		private:
			...
			key_compare	_comp;
			Allocator	_alloc;
			typename allocator_type::template rebind<Node>::other	_allocNode;
...
///////////////////////////************************////////////////////////////////
	...
	// construct/copy/destroy:
		explicit map(const Compare& comp = Compare(),
				...
				_root(NULL), _end(NULL), _size(0), _comp(comp), _alloc(alloc) {getEnd();}
...
///////////////////////////************************////////////////////////////////
		...
		T& at(const Key &x) {
			if (searchIt(_root, ft::make_pair(x.first, mapped_type()))) {

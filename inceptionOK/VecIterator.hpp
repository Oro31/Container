...
namespace ft {
	...
	class VecIterator {
		...
		public:
			...
			VecIterator &operator=(const VecIterator<typename ft::remove_const<T>::type> &mit) {
				p = mit.base();
				return *this;
			};
			VecIterator(const VecIterator<typename ft::remove_const<T>::type> &mit) : p(mit.base()) {};
